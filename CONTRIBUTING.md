# Contributing to DanaCore Record Management App API

First off, thanks for taking the time to contribute! The following is a set of guidelines for contributing to DanaCore Record Management App API.
...
We strive to foster a positive and inclusive community. Please be respectful and follow our [Code of Conduct](https://github.com/navedrasul/danacore-record-management-api/blob/main/CODE_OF_CONDUCT.md).

Thank you for your contributions! Together, we can make DanaCore Record Management App API better for everyone.
